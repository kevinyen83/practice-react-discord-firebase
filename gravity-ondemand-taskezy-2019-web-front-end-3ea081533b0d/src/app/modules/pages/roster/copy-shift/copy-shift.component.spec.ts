...
import { CopyShiftComponent } from './copy-shift.component';
...
describe('CopyShiftComponent', () => {
  let component: CopyShiftComponent;
  let fixture: ComponentFixture<CopyShiftComponent>;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ CopyShiftComponent ],
      providers: [
    ...
    beforeEach(() => {
    fixture = TestBed.createComponent(CopyShiftComponent);
