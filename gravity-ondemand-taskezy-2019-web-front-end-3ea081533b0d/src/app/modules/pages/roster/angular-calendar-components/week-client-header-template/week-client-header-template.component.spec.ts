...
import { WeekClientHeaderTemplateComponent } from './week-client-header-template.component';

describe('WeekClientHeaderTemplateComponent', () => {
  let component: WeekClientHeaderTemplateComponent;
  let fixture: ComponentFixture<WeekClientHeaderTemplateComponent>;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [WeekClientHeaderTemplateComponent]
    }).compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(WeekClientHeaderTemplateComponent);
