...
const customPalettes = {
    ...
    taskezyBlue: generatePalette('#369BE5'),
    taskezyGray: generatePalette('#64748b'),
    taskezyError: generatePalette('#FF1A1A'),
    taskezySuccess: generatePalette('#14B8A6'),
    taskezyWarning: generatePalette('#FFBF55'),
    taskezyDanger: generatePalette('#DB2777')
};
...
const themes = {
    ...
    'taskezy'  : {
        primary: customPalettes.taskezyBlue,
        accent: customPalettes.taskezyGray,
        warn: customPalettes.taskezyError,
        'error': customPalettes.taskezyError,
        'success': customPalettes.taskezySuccess,
        'warning': customPalettes.taskezyWarning,
        'danger': customPalettes.taskezyDanger
    },
};
